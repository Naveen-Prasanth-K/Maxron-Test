...
import { Dimensions, Image, FlatList, Pressable, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
    ...
    return (
        <>
            <FlatList
                ...
                data={Store?.deviceServiceCompleteData?.length && Store?.deviceServiceCompleteData}
